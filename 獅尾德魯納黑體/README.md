...
獅尾德魯納黑體基於[思源黑體](https://github.com/adobe-fonts/source-han-sans)的右側變圓和拔腳改造，更加簡明現代化的字體。支援简体中文、繁體中文、韓文與日文；可以免費商用，歡迎大家自由應用、自由優化、自由改作！

「獅尾德魯納黑體」與「獅尾D露西」差別在筆觸是否有做調整，獅尾德魯納黑體所套用的效果較少，在筆觸沒有做調整。

![字體預覽](https://github.com/max32002/swei-del-luna-sans/raw/master/preview/welcome.png)

和思源黑體一樣，支援7種的字重：
![字體比較預覽](https://github.com/max32002/swei-del-luna-sans/raw/master/preview/compare_style.png)
...
### 「CJK TC」和「CJK SC」的比較：
![TC和SC比較](https://github.com/max32002/swei-del-luna-sans/raw/master/preview/compare_tc_sc.png)
...
## 更新日誌
[點擊此處](https://github.com/max32002/swei-del-luna-sans/blob/master/change_log.md) 查看更新記錄。
...
@font-face {
  ...
  src: url(https://cdn.jsdelivr.net/gh/max32002/swei-del-luna-sans@2.129/WebFont/CJK%20TC/SweiDelLunaSansCJKtc-Regular.woff2) format("woff2")
  , url(https://cdn.jsdelivr.net/gh/max32002/swei-del-luna-sans@2.129/WebFont/CJK%20TC/SweiDelLunaSansCJKtc-Regular.woff) format("woff");
}
```
